...
class Student(db.Model):
    ...
    belt_color = db.Column(db.Enum(Belt, values_callable= lambda f :[str(member.value) for member in Belt]), default=Belt.WHITE.value, server_default=Belt.WHITE.value)
